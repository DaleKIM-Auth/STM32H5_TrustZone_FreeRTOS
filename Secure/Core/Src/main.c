...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_ConfigPinAttributes(YELLOW_GPIO_Port, YELLOW_Pin, GPIO_PIN_NSEC);

  /*IO attributes management functions */
  HAL_GPIO_ConfigPinAttributes(GREEN_GPIO_Port, GREEN_Pin, GPIO_PIN_NSEC);

  /*IO attributes management functions */
  HAL_GPIO_ConfigPinAttributes(GPIOD, GPIO_PIN_8|GPIO_PIN_9, GPIO_PIN_NSEC);

  /*IO attributes management functions */
  HAL_GPIO_ConfigPinAttributes(RED_GPIO_Port, RED_Pin, GPIO_PIN_NSEC);
